      ...
      <div id="login-screen" className="lock-screen">
        <div style={{background:'white', padding:'40px', borderRadius:'20px', width:'320px', textAlign:'center'}}>
          ...
          <form id="loginForm">
            ...
            <button type="submit" style={{width:'100%', padding:'12px', background:'#4f46e5', color:'white', border:'none', borderRadius:'8px', fontWeight:'bold', cursor:'pointer'}}>Entrar</button>
          </form>
      ...
      <div id="app-content" className="app-wrapper" style={{ display: 'none' }}>
        <header className="app-header">
          <div>
            ...
            <p style={{margin:0, opacity:0.7}}>Bienvenido, <span id="userNameDisplay"></span></p>
          </div>
        ...
        <div className="section-box">
          <h3 style={{marginTop:0}}>🗒️ Historial de Movimientos</h3>
        ...
        {/* PANEL DE CLAVES (SOLO JOSUE) */}
        <div id="manager-panel" className="section-box" style={{ display: 'none', border:'2px solid #f59e0b' }}>
          <h3 style={{color:'#f59e0b', marginTop:0}}>🔑 Panel Maestro de Recuperación</h3>
          <table className="data-table">
        ...
        <form id="transactionForm" className="entry-form">
          ...
          <input type="text" id="description" placeholder="¿En qué se gastó/ganó?" required />
          <input type="number" id="amount" placeholder="0.00" step="0.01" required />
          <input type="date" id="dateInput" required />
          <select id="category">
            <option value="Comida">🍔 Comida</option><option value="Servicios">💡 Servicios</option>
            <option value="Transporte">🚗 Transporte</option><option value="Salud">🏥 Salud</option><option value="Otros">📦 Otros</option>
          </select>
