    ...
    <>
      ...
      <div id="app-content" className="app-wrapper" style={{ display: 'none' }}>
        <header className="app-header">
          <h1>💰 Finanzas PRO <small style={{fontSize:'14px', opacity:0.8}}>| <span id="userNameDisplay"></span></small></h1>
        ...
        <div className="balance-grid">
          ...
          <div className="b-card ba"><h3>Balance</h3><p id="totalSavings" style={{fontSize:'28px', fontWeight:'bold'}}>L 0.00</p></div>
        </div>

        <div id="manager-panel" className="section-box" style={{ display: 'none', border:'2px solid orange' }}>
          <h3 style={{color:'orange', margin:0}}>🔑 Panel Maestro (Josue)</h3>
        ...
        <div id="user-security" className="section-box">
          <h3>🛡️ Seguridad: Cambiar mi Clave</h3>
          <div style={{display:'flex', gap:'10px'}}>
            ...
            <button id="updatePassBtn" style={{background:'#10b981', color:'white', border:'none', padding:'10px 20px', borderRadius:'8px', cursor:'pointer', fontWeight:'bold'}}>Actualizar</button>
          </div>
        </div>
        ...
        <form id="transactionForm" className="entry-form">
          ...
          <button type="submit" id="mainSubmitBtn" className="btn-primary">Agregar</button>
        </form>
      </div>
    </>
  );
